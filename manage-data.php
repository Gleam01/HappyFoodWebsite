 ...
 function addFilleul($idParrain, $id_nfilleul, $id_parrain_in_user)
    {
      ...
      try {
              $requete3=$pdo->prepare("INSERT INTO `filleuls` ( `User_idUser`, `Parrain_idParrain`, `Parrain_User_idUser`) VALUES (?,?,?);"

           );


            $rs=$requete3->execute(array($id_nfilleul, $idParrain, $id_parrain_in_user ));
            if($rs)
            {
