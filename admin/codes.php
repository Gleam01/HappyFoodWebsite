<?php
  ...
  if ($_SESSION['role'] != 1) header('Location: http://localhost/HappyFoodWebsite/admin/users.php');
?>
<!DOCTYPE html>
<html lang="fr">
  <head>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.submit').click(function() {
          ...
          $.ajax({
            type: 'POST',
            url: 'http://localhost/HappyFoodWebsite/admin/genere_code.php',
            data: dataString,
        ...
        $('.sell_one_request').click(function() {
          ...
          $.ajax({
            type: 'POST',
            url: 'http://localhost/HappyFoodWebsite/admin/sell.php',
            data: dataString,
            success: function(data) {
              if (data == 0) {
