    ...
    <section class="row">
      <div class="mx-auto w-50">
        <?php
          ...
          $count_query = $database->query('SELECT COUNT(*) AS total_inputs FROM parrain_has_step WHERE Step_idStep = 2 AND readyUp = 0');
          ...
          $get_query = $database->query("SELECT * FROM parrain_has_step WHERE Step_idStep = 2 AND readyUp = 0 LIMIT $per_page OFFSET $start");
        ?>
        <h2>Liste des utilisateurs de l'étape 1</h2>
